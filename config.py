...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8526763711:AFhTxRHU_HBFZUawV5JnskkJ5IT5vIx0FU")
MONGO_URI = os.environ.get("MONGO_URI", "mongodb+srv://yan930691_db_user:1350198842312win@cluster0.redsjar.mongodb.net/?appName=Cluster0")
DATABASE_NAME = os.environ.get("DATABASE_NAME", "wznmovbot")
MAX_BUTTONS = 100
ALLOWED_USER_IDS = []  # ဗလာထားရင် အကုန်ခွင့်ပြု
